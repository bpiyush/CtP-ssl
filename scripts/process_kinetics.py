...
def parse_args():
    ...
    parser.add_argument('--raw_dir', default='/scratch-shared/fmthoker/kinetics/VideoData/',
                        type=str, help='raw data directory')
    parser.add_argument('--out_dir', default='data/kinetics/',
                        type=str, help='output data directory.')
    parser.add_argument('--ann_dir', default='/scratch-shared/fmthoker/kinetics/labels/',
